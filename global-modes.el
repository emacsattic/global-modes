...
;; Author: Hans van Dam <hans_van_dam@hetnet.nl>
...
;; (global-set-key [f4] 'global-hs-minor-mode)
;;
;; means hs-minor-mode can be toggled for all buffers except those with
major mode
;; C-mode or Emacs-lisp-mode at once by pressing f4.
;;
;; if for instance you want to make hs-minor-mode fully global you can
execute:
